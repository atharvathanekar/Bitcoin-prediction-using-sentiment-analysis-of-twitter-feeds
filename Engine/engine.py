...
account_sid = "AC03ef332c75a62b4aafe2a63a4e7436d8"
# Your Auth Token from twilio.com/console
auth_token  = "76a6388402f74897a81af72cda74e336"

client = Client(account_sid, auth_token)

btc = pd.read_csv('F:\\bitcoin1\\Engine\\live_bitcoin_txt.txt')
btc.columns = ["Time","Price"]
sent = pd.read_csv('F:\\bitcoin1\\Engine\\live_tweet_txt.txt')
sent.columns = ["Time","Sentiment"]
merged = sent.merge(btc, left_index=False, right_index=False, how="inner")
merged.to_csv('F:\\bitcoin1\\Engine\\merged_data_txt.csv')

data = pd.read_csv("F:\\bitcoin1\\Engine\\merged_data_txt.csv")
...
#Using Loopback 1 because we got less RMSE value
#With sentiment and lookback 2
look_back = 2
...
dsn_database = "bitcoin123"         # e.g. "MySQLdbtest"
dsn_hostname = "173.194.109.182"      # e.g.: "mydbinstance.xyz.us-east-1.rds.amazonaws.com"
dsn_port = 3306                  # e.g. 3306 
dsn_uid = "root"             # e.g. "user1"
dsn_pwd = "abc123"              # e.g. "Password123"
...
threshold = 0.05
while True:
    btc = open('F:\\bitcoin1\\Engine\\live_bitcoin_txt.txt','r')
    sent = open('F:\\bitcoin1\\Engine\\live_tweet_txt.txt','r')
    ...
    if val > threshold:
        decision = 'Buy!!!'
        message = client.messages.create(to="whatsapp:+918655078690", from_="whatsapp:+14155238886", body=decision+' - Price of Bitcoin is expected to rise.')
    elif val <-threshold:
        decision = 'Sell!!!'
